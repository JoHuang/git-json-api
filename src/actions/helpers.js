...
exports.getSchema = async function(tree) {
...
exports.treeToObject = async function(tree) {
  const result = {}
...
exports.entryToObject = async function(entry) {
  if (entry.isTree()) {
...
exports.getVersion = async function(repo, version) {
  if (version === "master") {
